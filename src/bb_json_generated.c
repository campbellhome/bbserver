...
config_t json_deserialize_config_t(JSON_Value *src)
{
	...
	if(src) {
		...
		if(obj) {
			...
			dst.tablesApi = json_object_get_boolean_safe(obj, "tablesApi");
...
view_config_t json_deserialize_view_config_t(JSON_Value *src)
{
	...
	if(src) {
		...
		if(obj) {
			...
			dst.titleInput = json_deserialize_sb_t(json_object_get_value(obj, "titleInput"));
...
JSON_Value *json_serialize_config_t(const config_t *src)
{
	...
	if(obj) {
		...
		json_object_set_boolean(obj, "tablesApi", src->tablesApi);
...
JSON_Value *json_serialize_view_config_t(const view_config_t *src)
{
	...
	if(obj) {
		...
		json_object_set_value(obj, "titleInput", json_serialize_sb_t(&src->titleInput));
