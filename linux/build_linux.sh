...
clang -c -g -Werror -Wall -Wextra -I../../bbclient/include -I../../bbclient/include/bbclient -I../../mc_common/include -I../../thirdparty ../../mc_common/src/*.c ../../thirdparty/parson/parson.c ../../thirdparty/sqlite/sqlite3.c
